...
<div class="card">
	<div class="card-header">
		<div class="card-title">
			<a href="{{ route('dokter.create') }}" class="btn btn-block btn-primary">Tambah Baru</a>
		</div>
			...
			<div class="input-group input-group-sm" style="width: 200px;">
	            ...
	            <div class="input-group-append">
	            	<button type="submit" class="btn btn-default">
	              	...
	              	<a href="{{ route('dokter.index') }}" type="submit" class="btn btn-default">
		  		...
		  		@if (count($data) > 0)
			  		@foreach($data as $row)
						<tr>
					  		...
					  		<td>
					  			<a href="{{ route('dokter.edit', $row->id) }}" alt="Edit Tanda Vital"><i class="far fa-edit"></i></a>
					  		</td>
						</tr>
					@endforeach
				@else
